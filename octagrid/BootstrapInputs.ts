...
export namespace bs {
    ...
    export class Button extends Input {
        ...
        constructor(options) {
            super();
            this.config = $.extend(this.defaults, options);
            this.elem = $("<button name='" + this.config.name + "'  type='button' class='" + this.config.class + "' command='" + this.config.command + "' >" + this.config.value + "</button>");
            this.name = this.config.name;
        }
        init(item) {
    ...
    export class BootStrapInputBuilder implements IInputBuilder {
